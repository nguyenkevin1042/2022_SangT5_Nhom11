					...
					<form action="#" method="post">
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<div style="position: relative;">
									<span class="fa fa-calendar icon"
										...
										type='text' class="form-control" id='arrival_date' />
								</div>
							</div>
							...
							<div class="col-sm-6 form-group">
								...
								<div style="position: relative;">
									<span class="fa fa-calendar icon"
										style="position: absolute; right: 10px; top: 10px;"></span> <input
										type='text' class="form-control" id='departure_date' />
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label for="room">Room</label> <select name="" id="room"
									class="form-control">
							...
							<div class="col-md-6 form-group">
								<label for="room">Guests</label> <select name="" id="room"
									class="form-control">
				...
				<div class="col-md-5">
					...
					<div class="media d-block room mb-0">
						...
						<div class="media-body">
							...
							<p>
								<a href="#" class="btn btn-primary btn-sm">Book Now From $20</a>
							</p>
						</div>
					</div>
				</div>
