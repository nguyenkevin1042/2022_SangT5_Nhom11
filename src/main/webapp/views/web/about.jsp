				...
				<div class="col-md-4">
					<div class="heading-wrap  element-animate">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
							...
							quibusdam est? Corporis deleniti obcaecati quibusdam inventore
							fuga eveniet! Qui delectus tempore amet!</p>
			...
			<div class="row ">
				<div class="col-md-4">
					<div class="post-entry">
						<img src="web/images/person_1.jpg" alt="Image placeholder"
							class="img-fluid">
						<div class="body-text">
